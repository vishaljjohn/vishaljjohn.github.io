...
(function () {
  ...
  var css = ''
   ...
   + '@media (max-width:480px){.vjw-panel{right:12px;bottom:80px;height:70vh;}.vjw-launch{right:14px;bottom:14px;}.vjw-call{right:80px;bottom:21px;height:42px;font-size:12px;padding:0 12px;}.vjw-tip{display:none;}}';
